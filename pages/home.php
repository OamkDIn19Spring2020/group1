<div class="gallery">
    <img src="assets/photos/photograph-1.jpg" alt="Photograph 2">
    <img src="assets/photos/photograph-2.jpg" alt="Photograph 2">
    <img src="assets/photos/photograph-3.jpg" alt="Photograph 3">
    <img src="assets/photos/photograph-4.jpg" alt="Photograph 4">
</div>
            ...
            <div class="well well-sm">
                <div class="row">
                    <div class="col-xs-12 col-md-6 text-center">
                        <h1 class="rating-num text-muted">4.0</h1>
                        <div class="rating">
                        ...
                        <div>
                            <span class="glyphicon glyphicon-user text-muted"></span>1,050,008 total
                        </div>
                    </div>
                    <div class="col-xs-12 col-md-6">
                        <div class="row rating-desc">
                            ...
                            <div class="col-xs-8 col-md-9">
                                <div class="progress">
                                <div class="progress-bar progress-bar-striped bg-warning" role="progressbar" style="width: 30%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">
                                </div>
                                </div>
                            </div>
                            <!-- end 2 -->
                            ...
                            <div class="col-xs-8 col-md-9">
                                <div class="progress">
                                <div class="progress-bar progress-bar-striped bg-danger" role="progressbar" style="width: 20%" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100">
                                </div>
                                </div>
                            </div>
                            <!-- end 1 -->
